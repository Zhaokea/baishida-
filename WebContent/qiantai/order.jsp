					...
					<tr>
						<td align="left" valign="top">
							...
							<div align="center" width="120">
								<form action="${pageContext.request.contextPath}/UserOrderServlet?action=queryOrderByPage&userId=${user.id}" name="form1" method="post">
										...
										<tbody style="margin: 0; padding: 0">
											...
											<tr>
												<td class="line_table" align="center" colspan="3"><a
													href="${pageContext.request.contextPath}/UserOrderServlet?action=queryOrderByPage&userId=${user.id}">我的所有订单</a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/UserOrderServlet?action=queryOrderByPage&delivery=0">未已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath}/UserOrderServlet?action=queryOrderByPage&delivery=1">已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
													
													<input type="hidden" name="delivery" value="${criteria.delivery}"/>
						...
						<tr>
								...
								<span class="left_bt2">第${pageCurrent.curPage}页
								   ...
								   <a href="javascript:queryOrderByPage(1)">[首页]</a>
								    ...
								    <!-- 判断：如果当前页为第一页，则curPage=1;如果当前页不是第一页， curPage=${pageCurrent.curPage-1}-->
								    
								    <c:if test="${pageCurrent.curPage!=1}">
								    	<a href="javascript:queryOrderByPage(${pageCurrent.curPage-1})">[上一页]</a>
								    </c:if>
								    <c:if test="${pageCurrent.curPage==1}">
								    	<!--  <a href="${pageContext.request.contextPath}/AdminOrderServlet?action=getAllOrderByPage&curPage=1">[上一页]</a>-->
...
<script type="text/javascript">
	...
	function queryOrderByPage(curPage){
		document.form1.action="${pageContext.request.contextPath}/UserOrderServlet?action=queryOrderByPage&curPage="+curPage;
		//提交搜索的form表单
